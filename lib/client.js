...
/**
 * Drops file from the underlaying system
 * @param {Object}   options:
 *   * filename  {String}  save with this filename
 *   * headers   {Object}  optional headers to pass
 * @param {Function} callback <err>
 */
S3Client.prototype.dropFile = function (options, callback) {
    var filename = options.filename,
        headers  = options.headers || {},
        s3 = this.s3;

    return new Promise(function dropFilePromise(resolve, reject) {
        s3.del(filename, headers)
            .on('response', function dropFileResponse(response) {
                if (response.statusCode !== 200) {
